...
<section>
    ...
    <div class="noi-dung">
        <div class="form">
            <h2>Trang Dang ky</h2>
            <form  action="/loginUser?action=createUser" method="post">
                <div class="input-form">
                    <span>Ten Nguoi Dung</span>
                    <input type="text" name="fullName" size="30"  placeholder="fullName" />
                </div>
                <div class="input-form">
                    <span>Ten tai khoan</span>
                    <input type="user" name="user" size="30" placeholder="user" />
                </div>
                <div class="input-form">
                    <span>Mat Khau</span>
